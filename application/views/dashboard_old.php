 ...
 document.getElementById('sidebar_icon_1').style.fill='#E46F0E';
    ...
    <!-- End Navbar -->
    <div class="container-fluid py-4" style="width: 102%">
      <div class="row mb-4">
        <!-- First Header start -->
        <div class="col-lg-12 col-md-12 mb-xl-2 mb-4">
          <div class="card dashboard_header ">
            <div class="row dashboard_header_content">
              <div class="col-2">
                <img class="logo" alt="100x100" src="<?php echo base_url()?>assets/images/student_portal_icon/Finger Tips 01.png" style="width: 221px;height: 184px;max-width: 185px;" id="logos" data-original-title="" title="">
              </div>
              <div class="col-8 header_text_center" >

                <span class="m-0 header_text1" >Welcome to Fingertips</span>
                <span class="header_text2">You have enrolled in Data Science Pro</span>

                <span class="header_text3">Your Batch: <?php echo $batch_name;?></span>
              </div>
              <div class="col-2 header_text4" style="font-size: 60px;font-family: 'Poppins' !important;margin-top: 29px;">  </div>
            </div>
          </div>
        </div>
        <!-- First Header end -->
...
<div class="card tab-content customScroll1" style="max-height:500px; overflow-y:auto; overflow-x:hidden;margin-top: 5px;">
   <div class="card  tabcontent" id="upcomming" >
               <div class="row">
                  <div class="col-md-12">
                                                <div class="card height-equal" >
                                                   <div class="card-body">
                                                      ...
                                                      <div class="upcoming-event">
                                                         ...
                                                         <div class="col-lg-8" style="margin-top: -20px !important;" >
                                                            <table>
                                                               <tr>
                                                                 <td>
                                                                ...
                                                                <br> 
                                                                 <td><span style="font-weight: 500;font-size: 17px;display: block;font-family: 'Poppins' !important;color: #5A5858;">Session : <?php echo $data['session_name']; ?></span>
                                                                    <span style="color: #949393;font-size:15px;">Course: <?php echo $course_name;?></span><br>
                                                                      <span  style="color: #949393;font-size:13px;"> Starts at: <?php  $mydate=getdate($data['session_date']); echo "$mydate[month] $mydate[mday]"?></span>
                                                             </td></tr>
                                                            </table>
                                                                 <ul
                                                                  class="nav"
                                                                  ...
                                                                  <li class="nav-item" style="cursor:pointer;"  
                                                                     ...
                                                                     >
                                                                           ...
                                                                           <button id="activity_button"  style="width:160px;margin-top:8px;margin-left: 75px;">
   ...
   <div class="card tabcontent customScroll1" style="max-height:500px; overflow-y:auto; overflow-x:hidden;" id="completed" >
                 <div class="row">
                                             <div class="col-md-12" style="margin-top: -7px !important;">
                                                   ...
                                                   <div class="card-body">
                                                      <div class="upcoming-event">
                                                         ...
                                                         <table>
                                                           <tr >
                                                             <td >
                                                                   <img src="<?php echo base_url()?>assets/images/student_portal_icon/Group 59.png"style="margin-top: 10px;">
                                                                </td>
                                                              <?php 
                                                                     $mydate=getdate($data10['session_date']);
                                                                    
                                                                     ?> 
                                                                     <td>  <span style="font-weight: 500;font-size: 17px;display: block;font-family: 'Poppins' !important;color: #5A5858;margin-top: 12px;color:#B1B1B1">Offline : <?php echo $data10['session_name']; ?></span>
                                                                      
                                                                        <span  style="color: #949393;font-size:15px;">Starts at: <?php echo "$mydate[month] $mydate[mday] " ?></span>
                                                                      <br>
                                                                     <span  style="color: #949393;font-size:13px;"> Course:
                                                               ...
                                                               <ul
                                                                  ...
                                                                  <li class="nav-item" style="cursor:pointer;"  
                                                                    ...
                                                                    <button id="activity_button" style="width:160px;margin-left: 75px;">
                                                                         <img src="<?php echo base_url()?>assets/images/student_portal_icon/reading-material.png">&nbsp;&nbsp;
                                                                  ...
                                                                  <li class="nav-item" style="cursor:pointer;"  
                                                                     ...
                                                                     >
                                                                     &nbsp;&nbsp; <button id="activity_button"><img src="<?php echo base_url()?>assets/images/student_portal_icon/page.png" style="margin-left:8px;">&nbsp;&nbsp;Session Resource &nbsp;&nbsp;&nbsp;&nbsp;</button></li>
          ...
          <div class="col-lg-4 col-md-12 mb-md-0 mb-4" >
            ...
            <div class="card h-auto mb-3" >
             ...
             <div class="card-body" >
              <div class="row">
               <div class="col-lg-4 col-md-4" style="color:#5A5858;font-size:16px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
                <span>Assignment</span>
                <span>1</span>
              </div><div class="col-lg-4  col-md-4" style="color:#5A5858;font-size:16px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
                <span>Project</span>
                <span>1</span>
              </div><div class="col-lg-4 col-md-4" style="color:#5A5858;font-size:16px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
              ...
              <div class="col-lg-12" style="text-align: end;margin-top: 30px;">
                <span style="font-size: 21px;color:#26266c;font-weight: 300;">  View More</span>  
              </div>
            </div>
          </div>
        </div>
         <a href="total-attendance">
        <div class="card h-auto mb-3" id="attendance">
         <div class="card-body">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12">
           <img src="<?php echo base_url()?>assets/attendance/85.png" alt="Nature" style="display: block;height: 250px;margin:auto;" >
 ...
 <div class="row mb-4 " style="
  ...
  <div class="col-lg-4 col-md-6">
    ...
    <div class="col-lg-4 col-md-6">
      <div class="card card-body" >
          <div class="row">
            ...
            <div class="col-md-9" style="font-size:21px;color: #5A5858">
    ...
    <div class="row mb-4">
      <div class="col-lg-8 col-md-12 mb-md-0 mb-4">
        <div class="card">
          <div class="card-body px-0 refer_Card" >
            <div class="row">
             <div class="col-lg-6 col-md-5">
              <img src="<?php echo base_url()?>assets/images/student_portal_icon/2784128.png" id="img" type="image/x-icon" style="width: 342px;height: 205px;margin-top:-20px;" data-original-title="" title="">
            </div>
            <div class="col-lg-5 col-md-6">
              <P class="refertoearn">REFER AND EARN <br>
              <p class="refertoearn1" style="font-weight:510;">Spread the gift of learning! Refer your friend
and get rewarded.</p></P>
