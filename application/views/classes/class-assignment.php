...
<?php
   $query = "SELECT `batch_id`,`assignment` FROM `offline_session` WHERE `id` = $session_id";
   $runfetch = mysqli_query($con, $query);
   $noofrow = mysqli_num_rows($runfetch);
   $indexnumber = 1;
   if ($noofrow >
...
<?php
   if (isset($_POST['assign_assignment'])) {
   
      $assignment_submission = $_POST['assignment_submission'];
      $assignment_submission_timestamp = strtotime($assignment_submission);
      $assignment_comment = $_POST['assignment_comment'];
   
       // updating ppt status
       $query4 = "UPDATE `offline_session_log` SET `assignment_stauts` = 1, `assignment_submission` = $assignment_submission_timestamp,`assignment_comment` = '$assignment_comment'  WHERE `session_id` = $session_id;";
   ...
   // retriving session data fromt the sesstino log 
      ...
      if ($noofrow >0 && $runfetch == TRUE) { 
            while ($data = mysqli_fetch_assoc($runfetch)) {
               ...
               $assignment_comment = $data['assignment_comment'];
...
<html lang="en">
   <head>
      ...
      <link
         ...
         type="image/x-icon"
         />
      <title>Class Assignment | Fingertip Portal</title>
      <!-- Google font-->
      <link
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <div class="card">
                                 <div class="card-body">
                                    <div class="pt-1">
                                       <h5 class="mb-5"><strong>Session Assignment</strong></h5>
                                    </div>
                                       ...
                                       <table class="display" id="basic-6">
                                          ...
                                          <tbody>
                                             <?php
                                                ...
                                                ?>
                                             <?php
                                                $query = "SELECT * FROM `assignment` WHERE is_deleted = 0 AND `id` = $assignment_array[$i];"; 
                                             ...
                                             <tr>
                                                ...
                                                <form action="download-material.php" method="get">
                                                ...
                                                <td>
                                                   <?php
                                                      $query100 = "SELECT `assignment_submission` FROM `offline_session_log` WHERE `session_id` = $session_id";
                                                      ...
                                                      if ($noofrow100 >0 && $runfetch100 == TRUE) { 
                                                        ...
                                                        { 
                                                         if($data100['assignment_submission'] == ""){
                                                            echo "Not Applied";
                                                         }else{
                                                         $mydate=getdate($data100['assignment_submission']);
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <div class="card">
                                 ...
                                 <div class="card-body">
                                    <!-- <h5 class="mb-5">Session Assignment</h5> -->
                                    <form action="" method="post">
                                             ...
                                             <!-- <div class="col-lg-12">
                                                <div class="form-group">
                                                   ...
                                                   <select
                                                      ...
                                                      required
                                                      >
                                                      <option label="Choose Assignment"></option>
                                                      <?php
                                                   $query = "SELECT * FROM `assignment` WHERE is_deleted = 0";
                                                   ...
                                                   if ($noofrow >0 && $runfetch == TRUE) { 
                                                     while ($data = mysqli_fetch_assoc($runfetch)) 
                                                     { ?>
                                                      <option value="<?php echo $data['id'];?>"><?php echo $data['assignment_name'];?></option>
                                                      <?php
                                                   }
                                                   }
...
<?php
   if (isset($_POST['class_assignment_next'])) {
    
      $uploadsuccess = 0;
      $uploadfail = 0;
   
    // updating ppt status
    $query4 = "UPDATE `offline_session_log` SET `assignment_stauts` = 1  WHERE `session_id` = $session_id;";
    ...
    if ($con->query($query4) === TRUE) {
      ...
      echo "<script>alert('hlo anzar');</script>";
      $uploadfail = 1;
      // echo "Error: " . $query3 . "<br>" . $con->error;
    }
    ...
    if($uploadsuccess == 1 && $uploadfail == 0){
      ?>
<script>
   window.location = "class-test.php?id=<?php echo $session_id; ?>";
</script>
<?php
   }
   }
   
   if (isset($_POST['class_assignment_skip'])) {
    
      $uploadsuccess = 0;
      $uploadfail = 0;
   
   // updating ppt status
   $query4 = "UPDATE `offline_session_log` SET `assignment_stauts` = 0  WHERE `session_id` = $session_id;";
