        ...
        <div class="col-lg-12 col-md-12 ">
          <div class="card dashboard_header ">
            <div class="row dashboard_header_content">
              ...
              <div class="col-md-6 col-lg-8 col-6 header_text_center" >
             ...
             <div class="card-body mobile_assignment"  >
              <div class="row" >
               <div class="col-lg-4 col-md-4 col-4" style="color:#5A5858;font-size:14px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
                ...
                <span>1</span>
              </div><div class="col-lg-4  col-md-4 col-4" style="color:#5A5858;font-size:14px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
                <span>Project</span>
                <span>1</span>
              </div><div class="col-lg-4 col-md-4 col-4"  style="color:#5A5858;font-size:14px;font-family: 'Poppins' !important;text-align: center;display: grid;text-align: center;font-weight: 500;">
        ...
        <div class="card" style="max-height: 85%;">
          <div class="card-body  " >
            ...
            <div class="col-lg-7 col-md-7 col-6">
              ...
              <p class="refertoearn1" style="font-size: clamp(12px,1vw, 12px);">Spread the gift of learning! Refer your friend and get rewarded.</p></P>
