...
<html lang="en">
   <head>
      ...
      <link
         ...
         type="image/x-icon"
         />
      <title>Add MCQ | Fingertips</title>
      <!-- Google font-->
      <link
                                       ...
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             ...
                                             <input
                                                class="form-control"
                                                type="text"
                                                name="option_a<?php echo $index_number; ?>"
                                                value=""
                                       ...
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             ...
                                             <input
                                                class="form-control"
                                                type="text"
                                                name="option_b<?php echo $index_number; ?>"
                                                value=""
                                       ...
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             ...
                                             <input
                                                class="form-control"
                                                type="text"
                                                name="option_c<?php echo $index_number; ?>"
                                                value=""
                                       ...
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             ...
                                             <input
                                                class="form-control"
                                                type="text"
                                                name="option_d<?php echo $index_number; ?>"
                                                value=""
                                    ...
                                    <div class="row">
                                       <div class="col-lg-6 mg-t-10 mg-b-20">
                                          ...
                                          <div
                                             ...
                                             >
                                             <input
                                                name="correct_option<?php echo $index_number; ?>"
                                                type="radio"
                                                class="custom-control-input"
                                                id="radio1<?php echo $index_number; ?>"
                                                value='a'
                                                checked
                                                required
                                                />
                                             <label class="custom-control-label" for="radio1<?php echo $index_number; ?>"
                                                >A</label
                                                >
                                          </div>
                                          &nbsp;&nbsp;&nbsp;
                                          <div
                                             ...
                                             <input
                                                ...
                                                class="custom-control-input"
                                                value='b'
                                                id="radio2<?php echo $index_number; ?>"
                                                required
                                                />
                                             <label class="custom-control-label" for="radio2<?php echo $index_number; ?>"
                                                >B</label
                                                >
                                          </div>
                                          &nbsp;&nbsp;&nbsp;
                                          <div
                                             ...
                                             <input
                                                ...
                                                type="radio"
                                                class="custom-control-input"
                                                id="radio3<?php echo $index_number; ?>"
                                                value='c'
                                                required
                                                />
                                             <label class="custom-control-label" for="radio3<?php echo $index_number; ?>"
                                                >C</label
                                                >
                                          </div>
                                          &nbsp;&nbsp;&nbsp;
                                          <div
                                             ...
                                             <input
                                                ...
                                                type="radio"
                                                class="custom-control-input"
                                                id="radio4<?php echo $index_number; ?>"
                                                value='d'
                                                required
                                                />
                                             <label class="custom-control-label" for="radio4<?php echo $index_number; ?>"
                                                >D</label
                                                >
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-lg-4">
                                          <div class="form-group">
                                             ...
                                             <input
                                                class="form-control"
                                                type="text"
                                                name="correct_answer_description<?php echo $index_number; ?>"
