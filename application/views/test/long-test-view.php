   ...
   if(!isset($_SESSION['ftip69_test_id'])){
    ...
    if($test_id == ''){
      // echo 'test_id'.$test_id;
       ?>
<script>
window.location = "fingertips.co.in/cloud/"
</script>
       <?php
    }else{
      //  echo 'not null<br>';
...
if (isset($_POST['complete_test'])) {
   $query4="UPDATE `mcq_test_log` SET `test_status`='complete',`test_end_time`=$timestamp WHERE `test_id` = $test_id AND `id` = $mcq_test_log_id";
}
                           ...
                           <div class="col-sm-12">
                              <div class="card">
                                 ...
                                 <div class="card-body">
                                    <h4>
                                       <?php
                                          ...
                                          $query100 = "SELECT * FROM `mcq_test_questions` WHERE `test_id` = $test_id ORDER BY `id` ASC LIMIT 1 OFFSET $offset"; 
                                          $runfetch100 = mysqli_query($con, $query100);
                                          $noofrow100 = mysqli_num_rows($runfetch100);
                                          ...
                                          $question_type=$data100['question_type'];
                                   ...
                                   <?php
                                    ...
                                    <div class="pt-2 form-group">
                                       ...
                                       <div class="form-group">
                                            <label for="pwd" style="font-size:23px" class="font-weight-bold">Answer: </label>
                                            <!-- <input type="textarea" class="form-control" placeholder="Enter answer" name='answer'> -->
                                          <?php
                                             // derive data from mcq test table
                                             $query111 = "SELECT `given_answer` FROM `mcq_test_questions_log` WHERE `mcq_test_log_id` = $mcq_test_log_id AND `mcq_test_question_id` = $mcq_test_question_id"; 
                                             $runfetch111 = mysqli_query($con, $query111);
                                             $noofrow111 = mysqli_num_rows($runfetch111);
                                             if ($noofrow111 >0 && $runfetch111 == TRUE) { 
                                             $data111 = mysqli_fetch_assoc($runfetch111);
                                             }
                                          ?>
                                            <textarea class="form-control" <?php if ($question_type==3) {
                                               echo "maxlength=500";
                                            }?> name="submit_answer" id="" cols="30" rows="5" placeholder="Type your Answer here.."><?php echo $data111['given_answer'];?></textarea>
                                            <small><?php if ($question_type==3) {
                                               echo "Maximum Answer Character allow is 500";
                                            }?></small>
                                        </div>
                                 ...
                                 <div class="card-footer">
                                   ...
                                   <a href="../test/long-test-view.php?q=<?php echo $question_number+1; ?>"><div class="btn btn-light">Skip </div></a>
                                 ...
                                 <div class="card-body">
                                    ...
                                    <div class="row pl-1">
                                       <?php
                                          ...
                                          $query100 = "SELECT * FROM `mcq_test_questions_log` WHERE `mcq_test_log_id` = $mcq_test_log_id ORDER BY `mcq_test_question_id` ASC "; 
                                          $runfetch100 = mysqli_query($con, $query100);
                                          $noofrow100 = mysqli_num_rows($runfetch100);
                                       ...
                                       <div class="col-2 text-center p-1">
                                          <a href="../test/long-test-view.php?q=<?php echo $matrix_question_number; ?>">
                                             <div
                                                style="
                                                width: 100%;
                                                height: 100%;
...
window.location = 'https://fingertips.co.in/cloud/en/auth/login.php';"
      ...
      <script>
         ...
         if (time_left < 0){
           ...
           window.location = "../test/mcq-test-result.php?id=<?php echo $test_id ?>"
         }
...
if (isset($_POST['mark_completed'])) {
   ...
   $submit_answer = $_POST['submit_answer'];  
   $submit_answer = htmlspecialchars($submit_answer, ENT_QUOTES, "UTF-8");
 
   $query3 = "UPDATE `mcq_test_questions_log` SET `given_answer` = '$submit_answer',`question_status`='completed' WHERE `mcq_test_log_id` = $mcq_test_log_id AND `mcq_test_question_id` = $mcq_test_question_id;";
   if ($con->query($query3)){
     ?>
 <script>
 window.location = "../test/long-test-view.php?q=<?php echo $question_number+1;  ?>";
 </script>
     <?php
