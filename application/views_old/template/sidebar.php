<body class="g-sidenav-show  bg-gray-200">
  ...
  <!-- <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main"> -->
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 sidebar_logo" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="<?php echo base_url();?>assets/images/logo/logo.png" class="navbar-brand-img h-100 " alt="main_logo">
      </a>
    </div>
    <div class="sidenav-header1">
      <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        <img src="<?php echo base_url();?>assets/images/student_portal_icon/profile.png" class="navbar-brand-img h-100 user_profile_image" alt="main_logo">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link text-white " href="<?php echo base_url();?>course">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
